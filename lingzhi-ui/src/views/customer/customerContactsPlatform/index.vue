<template>
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" :inline="true" v-show="showSearch" label-width="68px">
      <el-form-item label="社交平台code" prop="platformCode">
        <el-input
          v-model="queryParams.platformCode"
          placeholder="请输入社交平台code"
          clearable
          size="small"
          @keyup.enter.native="handleQuery"
        />
      </el-form-item>
      <el-form-item label="社交平台名称" prop="platformName">
        <el-input
      ...
      <el-form-item label="社交平台账号" prop="platformAccount">
        <el-input
          v-model="queryParams.platformAccount"
          placeholder="请输入社交平台账号"
          clearable
          size="small"
          @keyup.enter.native="handleQuery"
        />
    ...
    <el-row :gutter="10" class="mb8">
      ...
      <el-col :span="1.5">
        <el-button
          ...
          @click="handleExport"
          v-hasPermi="['system:platform:export']"
        >导出</el-button>
      </el-col>
    ...
    <el-table v-loading="loading" :data="platformList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="社交平台code" align="center" prop="platformCode" />
      <el-table-column label="社交平台名称" align="center" prop="platformName" />
      <el-table-column label="社交平台账号" align="center" prop="platformAccount" />
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        <el-form-item label="社交平台code" prop="platformCode">
          <el-input v-model="form.platformCode" placeholder="请输入社交平台code" />
        </el-form-item>
        <el-form-item label="社交平台名称" prop="platformName">
          <el-input v-model="form.platformName" placeholder="请输入社交平台名称" />
        </el-form-item>
        <el-form-item label="社交平台账号" prop="platformAccount">
          <el-input v-model="form.platformAccount" placeholder="请输入社交平台账号" />
        </el-form-item>
        <el-form-item label="所属联系人id" prop="contactId">
...
<script>
import { listPlatform, getPlatform, delPlatform, addPlatform, updatePlatform, exportPlatform } from "@/api/customer/customerContactsPlatform";
...
export default {
  ...
  methods: {
    ...
    handleDelete(row) {
      ...
      this.$confirm('是否确认删除客户联系人社交账号信息编号为"' + ids + '"的数据项?', "警告", {
    ...
    handleExport() {
      ...
      this.$confirm('是否确认导出所有客户联系人社交账号信息数据项?', "警告", {
          confirmButtonText: "确定",
          cancelButtonText: "取消",
          type: "warning"
        }).then(() => {
