<template>
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" :inline="true" v-show="showSearch" label-width="68px">
      <el-form-item label="客户状态名称" prop="statusName">
        <el-input
    ...
    <el-table v-loading="loading" :data="statusList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="客户状态名称" align="center" prop="statusName" />
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        <el-form-item label="客户状态名称" prop="statusName">
          <el-input v-model="form.statusName" placeholder="请输入客户状态名称" />
        </el-form-item>
        <!-- <el-form-item label="删除标志 0未删除 1已删除" prop="isDelete">
...
<script>
import { listStatus, getStatus, delStatus, addStatus, updateStatus, exportStatus } from "@/api/customer/customerStatus";
...
export default {
  ...
  methods: {
    ...
    handleDelete(row) {
      ...
      this.$confirm('是否确认删除客户状态信息编号为"' + ids + '"的数据项?', "警告", {
    ...
    handleExport() {
      ...
      this.$confirm('是否确认导出所有客户状态信息数据项?', "警告", {
          confirmButtonText: "确定",
          cancelButtonText: "取消",
          type: "warning"
        }).then(() => {
