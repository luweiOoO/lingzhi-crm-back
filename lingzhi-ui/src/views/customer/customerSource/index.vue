<template>
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" :inline="true" v-show="showSearch" label-width="68px">
      ...
      <el-form-item label="客户来源名称" prop="sourceName">
        <el-input
          v-model="queryParams.sourceName"
          placeholder="请输入客户来源名称"
          clearable
          size="small"
          @keyup.enter.native="handleQuery"
        />
      </el-form-item>
      <el-form-item label="客户来源编码" prop="sourceCode">
        <el-input
          v-model="queryParams.sourceCode"
          placeholder="请输入客户来源编码"
          clearable
          size="small"
          @keyup.enter.native="handleQuery"
        />
    ...
    <el-table v-loading="loading" :data="sourceList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="客户来源名称" align="center" prop="sourceName" />
      <el-table-column label="客户来源编码" align="center" prop="sourceCode" />
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        ...
        <el-form-item label="客户来源名称" prop="sourceName">
          <el-input v-model="form.sourceName" placeholder="请输入客户来源名称" />
        </el-form-item>
        <el-form-item label="客户来源编码" prop="sourceCode">
          <el-input v-model="form.sourceCode" placeholder="请输入客户来源编码" />
        </el-form-item>
        <!-- <el-form-item label="删除标志 0未删除 1已删除" prop="isDelete">
...
<script>
import { listSource, getSource, delSource, addSource, updateSource, exportSource } from "@/api/customer/customerSource";
...
export default {
  ...
  methods: {
    ...
    handleDelete(row) {
      ...
      this.$confirm('是否确认删除客户来源信息编号为"' + ids + '"的数据项?', "警告", {
    ...
    handleExport() {
      ...
      this.$confirm('是否确认导出所有客户来源信息数据项?', "警告", {
          confirmButtonText: "确定",
          cancelButtonText: "取消",
          type: "warning"
        }).then(() => {
