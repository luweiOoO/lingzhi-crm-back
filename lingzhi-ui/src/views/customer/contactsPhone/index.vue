<template>
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" :inline="true" v-show="showSearch" label-width="68px">
      <el-form-item label="电话所属区域id" prop="regionId">
        <el-input
          v-model="queryParams.regionId"
          placeholder="请输入电话所属区域id"
          clearable
          size="small"
          @keyup.enter.native="handleQuery"
        />
      </el-form-item>
      <el-form-item label="电话所属区域中文名称" prop="regionChineseName">
        <el-input
          v-model="queryParams.regionChineseName"
          placeholder="请输入电话所属区域中文名称"
          clearable
          size="small"
          @keyup.enter.native="handleQuery"
        />
      </el-form-item>
      <el-form-item label="电话所属区域前缀" prop="regionPhonePrefix">
        <el-input
          v-model="queryParams.regionPhonePrefix"
          placeholder="请输入电话所属区域前缀"
          clearable
          size="small"
          @keyup.enter.native="handleQuery"
        />
      ...
      <el-form-item label="所属联系人id" prop="contactId">
        <el-input
          v-model="queryParams.contactId"
          placeholder="请输入所属联系人id"
          clearable
          size="small"
          @keyup.enter.native="handleQuery"
        />
    ...
    <el-row :gutter="10" class="mb8">
      ...
      <el-col :span="1.5">
        <el-button
          ...
          :disabled="multiple"
          @click="handleDelete"
          v-hasPermi="['system:phone:remove']"
        >删除</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          @click="handleExport"
          v-hasPermi="['system:phone:export']"
        >导出</el-button>
      </el-col>
    ...
    <el-table v-loading="loading" :data="phoneList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="电话所属区域id" align="center" prop="regionId" />
      <el-table-column label="电话所属区域中文名称" align="center" prop="regionChineseName" />
      <el-table-column label="电话所属区域前缀" align="center" prop="regionPhonePrefix" />
      <el-table-column label="电话号码" align="center" prop="phoneNumber" />
      <el-table-column label="所属联系人id" align="center" prop="contactId" />
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        <el-form-item label="电话所属区域id" prop="regionId">
          <el-input v-model="form.regionId" placeholder="请输入电话所属区域id" />
        </el-form-item>
        <el-form-item label="电话所属区域中文名称" prop="regionChineseName">
          <el-input v-model="form.regionChineseName" placeholder="请输入电话所属区域中文名称" />
        </el-form-item>
        <el-form-item label="电话所属区域前缀" prop="regionPhonePrefix">
          <el-input v-model="form.regionPhonePrefix" placeholder="请输入电话所属区域前缀" />
        </el-form-item>
        <el-form-item label="电话号码" prop="phoneNumber">
          <el-input v-model="form.phoneNumber" placeholder="请输入电话号码" />
        </el-form-item>
        <el-form-item label="所属联系人id" prop="contactId">
          <el-input v-model="form.contactId" placeholder="请输入所属联系人id" />
        </el-form-item>
        <el-form-item label="创建人昵称" prop="createdUserName">
...
<script>
import { listPhone, getPhone, delPhone, addPhone, updatePhone, exportPhone } from "@/api/customer/contactsPhone";
...
export default {
  ...
  methods: {
    ...
    handleDelete(row) {
      ...
      this.$confirm('是否确认删除客户联系人联系电话信息编号为"' + ids + '"的数据项?', "警告", {
    ...
    handleExport() {
      ...
      this.$confirm('是否确认导出所有客户联系人联系电话信息数据项?', "警告", {
          confirmButtonText: "确定",
          cancelButtonText: "取消",
          type: "warning"
        }).then(() => {
          this.exportLoading = true;
          return exportPhone(queryParams);
        }).then(response => {
