<template>
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" :inline="true" v-show="showSearch" label-width="68px">
      <el-form-item label="客户分组名称" prop="groupName">
        <el-input
      ...
      <el-form-item label="父级分组" prop="pGroupId">
        <el-input
          v-model="queryParams.pGroupId"
          placeholder="请输入父级分组"
          clearable
          size="small"
          @keyup.enter.native="handleQuery"
      ...
      <!-- <el-form-item label="分组层级" prop="gourpLevel">
        <el-input
          v-model="queryParams.gourpLevel"
          placeholder="请输入分组层级"
          clearable
          size="small"
          @keyup.enter.native="handleQuery"
    ...
    <el-table v-loading="loading" :data="groupList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="客户分组名称" align="center" prop="groupName" />
      <el-table-column label="父级分组id" align="center" prop="pGroupId" />
      <!-- <el-table-column label="分组层级" align="center" prop="gourpLevel" />
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        <el-form-item label="客户分组名称" prop="groupName">
          <el-input v-model="form.groupName" placeholder="请输入客户分组名称" />
        </el-form-item>
        <el-form-item label="父级分组id" prop="pGroupId">
          <el-input v-model="form.pGroupId" placeholder="请输入父级分组id" />
        </el-form-item>
        <!-- <el-form-item label="分组层级" prop="gourpLevel">
          <el-input v-model="form.gourpLevel" placeholder="请输入分组层级" />
        </el-form-item>
        <el-form-item label="创建人昵称" prop="createdUserName">
...
<script>
import { listGroup, getGroup, delGroup, addGroup, updateGroup, exportGroup } from "@/api/customer/customerGroup";
...
export default {
  ...
  methods: {
    ...
    handleDelete(row) {
      ...
      this.$confirm('是否确认删除客户分组信息编号为"' + ids + '"的数据项?', "警告", {
    ...
    handleExport() {
      ...
      this.$confirm('是否确认导出所有客户分组信息数据项?', "警告", {
          confirmButtonText: "确定",
          cancelButtonText: "取消",
          type: "warning"
        }).then(() => {
