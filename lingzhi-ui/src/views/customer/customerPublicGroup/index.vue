<template>
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" :inline="true" v-show="showSearch" label-width="68px">
      <el-form-item label="公海分组名称" prop="publicGroupName">
        <el-input
          v-model="queryParams.publicGroupName"
          placeholder="请输入公海分组名称"
          clearable
          size="small"
          @keyup.enter.native="handleQuery"
        />
      </el-form-item>
      <el-form-item label="父级公海分组" prop="pPublicGroupId">
        <el-input
          v-model="queryParams.pPublicGroupId"
          placeholder="请输入父级公海分组"
          clearable
          size="small"
          @keyup.enter.native="handleQuery"
        />
      </el-form-item>
      <!-- <el-form-item label="公海分组层级" prop="publicGourpLevel">
        <el-input
          v-model="queryParams.publicGourpLevel"
          placeholder="请输入公海分组层级"
          clearable
          size="small"
          @keyup.enter.native="handleQuery"
        />
    ...
    <el-table v-loading="loading" :data="groupList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="公海分组名称" align="center" prop="publicGroupName" />
      <el-table-column label="父级公海分组id" align="center" prop="pPublicGroupId" />
      <!-- <el-table-column label="公海分组层级" align="center" prop="publicGourpLevel" />
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        <el-form-item label="公海分组名称" prop="publicGroupName">
          <el-input v-model="form.publicGroupName" placeholder="请输入公海分组名称" />
        </el-form-item>
        <el-form-item label="父级公海分组id" prop="pPublicGroupId">
          <el-input v-model="form.pPublicGroupId" placeholder="请输入父级公海分组id" />
        </el-form-item>
        <!-- <el-form-item label="公海分组层级" prop="publicGourpLevel">
          <el-input v-model="form.publicGourpLevel" placeholder="请输入公海分组层级" />
        </el-form-item>
        <el-form-item label="创建人昵称" prop="createdUserName">
...
<script>
import { listGroup, getGroup, delGroup, addGroup, updateGroup, exportGroup } from "@/api/customer/customerPublicGroup";
...
export default {
  ...
  methods: {
    ...
    handleDelete(row) {
      ...
      this.$confirm('是否确认删除客户公海分组信息编号为"' + ids + '"的数据项?', "警告", {
    ...
    handleExport() {
      ...
      this.$confirm('是否确认导出所有客户公海分组信息数据项?', "警告", {
          confirmButtonText: "确定",
          cancelButtonText: "取消",
          type: "warning"
        }).then(() => {
