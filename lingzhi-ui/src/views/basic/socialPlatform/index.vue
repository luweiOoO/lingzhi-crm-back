<template>
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" :inline="true" v-show="showSearch" label-width="68px">
      <el-form-item label="社交平台编码" prop="platformCode">
        <el-input
          v-model="queryParams.platformCode"
          placeholder="请输入社交平台编码"
          clearable
          size="small"
    ...
    <el-table v-loading="loading" :data="platformList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="社交平台编码" align="center" prop="platformCode" />
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        <el-form-item label="社交平台编码" prop="platformCode">
          <el-input v-model="form.platformCode" placeholder="请输入社交平台编码" />
        </el-form-item>
        <el-form-item label="社交平台名称" prop="platformName">
...
<script>
import { listPlatform, getPlatform, delPlatform, addPlatform, updatePlatform, exportPlatform } from "@/api/basic/socialPlatform";
...
export default {
  ...
  methods: {
    ...
    handleDelete(row) {
      ...
      this.$confirm('是否确认删除社交平台信息编号为"' + ids + '"的数据项?', "警告", {
    ...
    handleExport() {
      ...
      this.$confirm('是否确认导出所有社交平台信息数据项?', "警告", {
          confirmButtonText: "确定",
          cancelButtonText: "取消",
          type: "warning"
        }).then(() => {
