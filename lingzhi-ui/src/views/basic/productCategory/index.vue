<template>
  <div class="app-container">
    ...
    >
      ...
      <el-form-item label="父级类别" prop="pCategoryId">
        <el-input
          v-model="queryParams.pCategoryId"
          placeholder="请选择父级类别"
          clearable
          size="small"
          @keyup.enter.native="handleQuery"
    ...
    >
      ...
      <el-table-column label="父级类别" align="center" prop="pCategoryId" />
      <!-- <el-table-column label="类别层级" align="center" prop="categoryLevel" /> -->
      ...
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        ...
        <el-form-item label="父级类别" prop="pCategoryId">
          <el-cascader
            ...
            clearable
          ></el-cascader>
          <!-- <el-input v-model="form.pCategoryId" placeholder="请选择父级类别" /> -->
        </el-form-item>
        <!-- <el-form-item label="类别层级" prop="categoryLevel">
          <el-input v-model="form.categoryLevel" placeholder="请输入类别层级" />
        </el-form-item>
        <el-form-item label="创建人昵称" prop="createdUserName">
...
} from "@/api/basic/productCategory";
...
export default {
  ...
  methods: {
    ...
    handleExport() {
      ...
      this.$confirm("是否确认导出所有产品类别信息数据项?", "警告", {
        confirmButtonText: "确定",
        cancelButtonText: "取消",
        type: "warning",
      })
