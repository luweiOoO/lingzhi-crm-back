<template>
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" :inline="true" v-show="showSearch" label-width="68px">
      <el-form-item label="时区名称" prop="zoneName">
        <el-input
    ...
    <el-table v-loading="loading" :data="zoneList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="时区名称" align="center" prop="zoneName" />
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        <el-form-item label="时区名称" prop="zoneName">
          <el-input v-model="form.zoneName" placeholder="请输入时区名称" />
        </el-form-item>
        <!-- <el-form-item label="创建人昵称" prop="createdUserName">
...
<script>
import { listZone, getZone, delZone, addZone, updateZone, exportZone } from "@/api/basic/timeZone";
...
export default {
  ...
  methods: {
    ...
    handleDelete(row) {
      ...
      this.$confirm('是否确认删除世界时区信息编号为"' + ids + '"的数据项?', "警告", {
    ...
    handleExport() {
      ...
      this.$confirm('是否确认导出所有世界时区信息数据项?', "警告", {
          confirmButtonText: "确定",
          cancelButtonText: "取消",
          type: "warning"
        }).then(() => {
