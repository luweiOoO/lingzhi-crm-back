<template>
  <div class="app-container">
    ...
    >
      ...
      <el-table-column fixed label="业务员姓名" align="center" prop="salesmanName" />
      <el-table-column
        label="订单状态"
        align="center"
        prop="orderStatus"
      ...
      <el-table-column label="付款方式" align="center" prop="paymentChannel" />
      <el-table-column label="金额USD" align="center" prop="goodsAmountPriceDollar" />
      <el-table-column
        label="收款情况"
        align="center"
      ...
      />
      <el-table-column label="客户国家" align="center" prop="customerCountry" />
      <el-table-column
        label="客户电话"
        align="center"
        prop="customerPhone"
...
export default {
  ...
  data() {
    return {
      ...
      form: {},
      //导入生产指示单接口地址
      uploadUrl: process.env.VUE_APP_BASE_API + "/salesman/import",
      // 表单校验
      rules: {},
    };
  },
  ...
  methods: {
    ...
    getList() {
      this.loading = true;
      listSalesmanOrder(this.queryParams).then((response) => {
