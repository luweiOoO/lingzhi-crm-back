...
/**
 * 客户联系人社交账号信息对象 customer_contacts_social_platform
 * 
 * @author ruoyi
 * @date 2021-06-01
 */
public class CustomerContactsSocialPlatform extends BaseEntity
{
    ...
    public String toString() {
        return new ToStringBuilder(this,ToStringStyle.MULTI_LINE_STYLE)
            ...
            .append("platformAccount", getPlatformAccount())
