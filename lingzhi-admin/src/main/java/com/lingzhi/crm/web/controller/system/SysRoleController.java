...
import com.lingzhi.crm.framework.web.service.SysPermissionService;
...
public class SysRoleController extends BaseController
{
     ...
     * @return
     */
    @GetMapping("/getDataTableList/{roleId}")
    public AjaxResult getDataTableList(@PathVariable Long roleId){
        try {
            List<TreeStringSelect> dataTableList = roleService.getDataTableList("", null, null);
            //查询该角色已过滤的字段列表
            List<String> checkedKeys = roleFilterFieldService.getFilterFieldNameListByRoleId(roleId);
            AjaxResult ajax = AjaxResult.success();
            ajax.put("data",dataTableList);
